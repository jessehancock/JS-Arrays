...
//Have divider return an Array with the first item in the array being the evens array and the second item in the Array being the odds array.
...
var user2 = {
    name: 'Jesse Hancock',
    email: 'jessehancock@gmail.com',
    password: 'iLoveJavaScript',
    username: 'infiniateLoop'
};
var user3 = {
    name: 'Carly Hancock',
    email: 'carlyHancock@gamil.com',
    password: 'iLoveJavaScript',
    username: 'infiniateLoop'
};
